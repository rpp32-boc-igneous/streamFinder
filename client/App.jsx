...
class App extends React.Component {
  ...
  render() {
    return (
      <div>
        <div id="header">
          <button id="loginButton" onClick={this.changePage}>
            Login
          </button>
        ...
        <div id="body">
          ...
          <div id="loginSignup_page">
            <Login_Signup />
            <button id="home_from_login" onClick={this.changePage}>
              home
            </button>
          </div>
          <div id="signup_page">
        ...
        <div id="footer">
          ...
          <div id="watchlistButton" className="footerButton">
            Watchlist
          </div>
          <div className="divider">|</div>
          <div id="settingsButton" className="footerButton">
            Settings
          </div>
        </div>
      </div>
