...
const ListItem = (props) => {
  ...
  return (
    <div class='listItem' value={props.id} onClick={props.closeWatchlist}>
      ...
      <div class='content_title'>{props.title} ({year})</div>
      <div class='contentDetail'>Rated {props.rating} | {props.runtime} min </div>
      <button class='removeBtn' onClick={props.removeItem}
                                value={props.id}>REMOVE</button>
    </div>
  )
}
